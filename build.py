...
def build_exe():
    ...
    pyinstaller_cmd = (
        "pyinstaller --onefile --name=\"BidCraft-AI\" "
        ...
        "--hidden-import=sqlalchemy --hidden-import=sqlalchemy.orm --hidden-import=sqlalchemy.ext.asyncio "
        "--hidden-import=alembic --hidden-import=aiosqlite "
        "--hidden-import=redis --hidden-import=redis.asyncio "
        "--hidden-import=minio --hidden-import=qdrant_client --hidden-import=qdrant_client.models "
        "--hidden-import=numpy --hidden-import=tiktoken "
        "--hidden-import=celery --hidden-import=celery.app --hidden-import=celery.backends "
        "--hidden-import=loguru --hidden-import=jose --hidden-import=jose.jwt "
        "--hidden-import=passlib --hidden-import=passlib.hash --hidden-import=bcrypt "
        "--hidden-import=httpx "
